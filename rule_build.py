...
def load_data_dictionary(
    keys, filenames, data_dir="", file_ext="", method="hdf5", loader=load_tensor
):
    """
    載入多個檔案並建立一個資料字典。
